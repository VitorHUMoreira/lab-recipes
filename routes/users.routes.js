...
router.post("/sign-up", async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      html: `<h2>Bem vindo ao Lab Recipes ${newUser.name}</h2><h5>Clique <a href=https://lab-recipes.netlify.app/activate-account/${newUser._id} target="_blank">AQUI</a> para ativar sua conta<h5>`,
    };
